...
namespace Arae
{
    public static class FindIcon
    {
        ...
        private static ImageSource FromHandle(IntPtr hBitmap)
        {
            return Imaging.CreateBitmapSourceFromHIcon(hBitmap, Int32Rect.Empty, BitmapSizeOptions.FromEmptyOptions());
        }

        public static void ExtractEx(string fileName, List<ImageSource> largeIcons,
            List<ImageSource> smallIcons, int firstIconIndex, int iconCount)
        {
            /*
             * Memory allocations
             */
            ...
            if (smallIcons != null)
            {
                ...
                {
                    smallIcons.Add(FromHandle(actualIconPtr));
                }
            }
            if (largeIcons != null)
            {
                ...
                {
                    largeIcons.Add(FromHandle(actualIconPtr));
                }
            }
        }

        public static List<ImageSource> ExtractEx(string fileName, SystemIconSize size,
            int firstIconIndex, int iconCount)
        {
            List<ImageSource> iconList = new List<ImageSource>();
        ...
        public static void Extract(string fileName, List<ImageSource> largeIcons, List<ImageSource> smallIcons)
        {
            int iconCount = GetIconsCountInFile(fileName);
            ExtractEx(fileName, largeIcons, smallIcons, 0, iconCount);
        }

        public static List<ImageSource> Extract(string fileName, SystemIconSize size)
        {
            int iconCount = GetIconsCountInFile(fileName);
            return ExtractEx(fileName, size, 0, iconCount);
        }

        public static ImageSource ExtractOne(string fileName, int index, SystemIconSize size)
        {
            try
            {
                List<ImageSource> iconList = ExtractEx(fileName, size, index, 1);
                return iconList[0];
            }
        ...
        public static void ExtractOne(string fileName, int index,
            out ImageSource largeIcon, out ImageSource smallIcon)
        {
            List<ImageSource> smallIconList = new List<ImageSource>();
            List<ImageSource> largeIconList = new List<ImageSource>();
            try
            {
                                                ...
                                                SystemIconSize size)
        {
            ...
            return size == SystemIconSize.Large ?
                FromHandle(Large[0]) : FromHandle(Small[0]);
        }
        ...
        public static ImageSource IconFromExtensionShell(string extension, SystemIconSize size)
        {
            ...
            return FromHandle(fileInfo.hIcon);
        }
        ...
        public static ImageSource IconFromResource(string resourceName)
        {
            ...
            return null;//new BitmapImage(assembly.GetManifestResourceStream(resourceName));
        }
        ...
        public static ImageSource ExtractFromRegistryString(string regString, SystemIconSize size)
        {
            string fileName;
            int index;
